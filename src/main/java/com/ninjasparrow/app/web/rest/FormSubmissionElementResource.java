        ...
        Optional<FormSubmissionElement> result = formSubmissionElementRepository
            ...
            .map(
                existingFormSubmissionElement -> {
                    if (formSubmissionElement.getFormSubmissionId() != null) {
                        existingFormSubmissionElement.setFormSubmissionId(formSubmissionElement.getFormSubmissionId());
                    }
                    if (formSubmissionElement.getElementId() != null) {
                        existingFormSubmissionElement.setElementId(formSubmissionElement.getElementId());
                    }
