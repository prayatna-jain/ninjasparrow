            ...
            .map(
                existingFormElement -> {
                    ...
                    if (formElement.getFormId() != null) {
                        existingFormElement.setFormId(formElement.getFormId());
                    }
                    if (formElement.getElementTypeId() != null) {
                        existingFormElement.setElementTypeId(formElement.getElementTypeId());
                    }
                    if (formElement.getLookupFieldId() != null) {
                        existingFormElement.setLookupFieldId(formElement.getLookupFieldId());
                    }
